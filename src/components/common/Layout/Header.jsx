...
import InflationToggle from '@/components/common/InflationToggle'
import TaxSlabSelector from '@/components/common/TaxSlabSelector'
import PreferencesMenu from '@/components/common/PreferencesMenu/PreferencesMenu'
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center gap-3">
            {/* Mobile/Tablet: Preferences Menu */}
            <PreferencesMenu />
