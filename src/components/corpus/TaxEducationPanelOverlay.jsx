 ...
 * Side panel overlay that displays comprehensive tax education information
 * Opens from the right side with smooth animation
 */
const TaxEducationPanelOverlay = ({ isOpen, onClose }) => {
                  ...
                  >
                    ...
                    <div className="space-y-2 text-sm text-gray-600 dark:text-gray-400">
                      ...
                      <div className="mt-3 p-3 bg-white dark:bg-gray-900 rounded border border-gray-200 dark:border-gray-700">
                        ...
                        <span className="text-gray-600 dark:text-gray-400">{approach.example}</span>
                      </div>
                    </div>
                  </div>
                ))}
...
export default TaxEducationPanelOverlay
